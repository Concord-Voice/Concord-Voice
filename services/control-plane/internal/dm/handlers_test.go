...
func TestListConversations_IncludesParticipants(t *testing.T) {
	...
	conv := testhelpers.JSONElem[map[string]interface{}](t, conversations, 0)
	participants := testhelpers.JSONField[[]interface{}](t, conv, "participants")
...
func TestListConversations_WithLastMessage(t *testing.T) {
	...
	conv := testhelpers.JSONElem[map[string]interface{}](t, conversations, 0)
	lm := testhelpers.JSONField[map[string]interface{}](t, conv, "last_message")
...
func TestListConversations_WithLastCallEvent(t *testing.T) {
	...
	lm := testhelpers.JSONField[map[string]interface{}](t, testhelpers.JSONElem[map[string]interface{}](t, conversations, 0), "last_message")
...
func TestOpenConversation_Idempotent(t *testing.T) {
	...
	conv1 := testhelpers.JSONField[map[string]interface{}](t, body1, "conversation")
	...
	conv2 := testhelpers.JSONField[map[string]interface{}](t, body2, "conversation")
...
func TestCreateGroup_NoName(t *testing.T) {
	...
	testhelpers.ParseJSON(t, w, &body)
	conv := testhelpers.JSONField[map[string]interface{}](t, body, "conversation")
	assert.True(t, testhelpers.JSONField[bool](t, conv, "is_group"))
}
...
func TestUpdateConversation_RenameGroup(t *testing.T) {
	...
	convID := testhelpers.JSONField[string](t, testhelpers.JSONField[map[string]interface{}](t, createBody, "conversation"), "id")
...
func TestGetMessages_MessageFields(t *testing.T) {
	...
	msg := testhelpers.JSONElem[map[string]interface{}](t, messages, 0)
...
func TestMarkRead_ResetsUnreadCount(t *testing.T) {
	...
	convs := testhelpers.JSONField[[]interface{}](t, listBody, "conversations")
	require.Len(t, convs, 1)
	assert.Equal(t, float64(2), testhelpers.JSONElem[map[string]interface{}](t, convs, 0)["unread_count"])
	...
	convs = testhelpers.JSONField[[]interface{}](t, listBody, "conversations")
	require.Len(t, convs, 1)
	assert.Equal(t, float64(0), testhelpers.JSONElem[map[string]interface{}](t, convs, 0)["unread_count"])
}
...
func TestGetVoiceParticipants_EmptyList(t *testing.T) {
	...
	var body map[string]interface{}
	testhelpers.ParseJSON(t, w, &body)
	participants := testhelpers.JSONField[[]interface{}](t, body, "participants")
...
func TestGetVoiceParticipants_WithParticipant(t *testing.T) {
	...
	p := testhelpers.JSONElem[map[string]interface{}](t, participants, 0)
...
func TestGetOrCreatePersonalThread_Idempotent(t *testing.T) {
	...
	var body1 map[string]interface{}
	testhelpers.ParseJSON(t, w1, &body1)
	conv1ID := testhelpers.JSONField[string](t, testhelpers.JSONField[map[string]interface{}](t, body1, "conversation"), "id")
	...
	var body2 map[string]interface{}
	testhelpers.ParseJSON(t, w2, &body2)
	conv2ID := testhelpers.JSONField[string](t, testhelpers.JSONField[map[string]interface{}](t, body2, "conversation"), "id")
...
func createTestGroup(t *testing.T, ts *testhelpers.TestServer, creator testhelpers.TestUser, members ...testhelpers.TestUser) string {
	...
	testhelpers.ParseJSON(t, w, &body)
	conv := testhelpers.JSONField[map[string]interface{}](t, body, "conversation")
	return testhelpers.JSONField[string](t, conv, "id")
}
...
func TestCreateGroupCreatorIsAdmin(t *testing.T) {
	...
	for _, p := range participants {
		participant := testhelpers.JSONAs[map[string]interface{}](t, p, "participant")
...
func TestListConversationsIncludesRole(t *testing.T) {
	...
	for _, c := range conversations {
		conv := testhelpers.JSONAs[map[string]interface{}](t, c, "conversation")
...
func TestAuthorizeDMVoiceForMediaPlane_OmittedCallIDRejectsStaleJoinAdmission(t *testing.T) {
	...
	oldCallID := uuid.MustParse(testhelpers.JSONField[string](t, oldJoinBody, "call_id"))
	...
	replacementCallID := uuid.MustParse(testhelpers.JSONField[string](t, acceptedBody, "call_id"))
...
func assertDMMediaEntitlements(t *testing.T, body map[string]interface{}, tier string) {
	...
	for i, v := range rawTiers {
		gotTiers[i] = testhelpers.JSONAs[string](t, v, "allowed_audio_tiers element")
	}
