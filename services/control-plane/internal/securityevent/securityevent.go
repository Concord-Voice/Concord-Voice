...
const (
	...
	ReasonServerMFAEnforcementEnabled        ReasonCode = "mfa_enforcement_enabled"
	ReasonServerMFAEnforcementDisabled       ReasonCode = "mfa_enforcement_disabled"
...
const (
	...
	RouteServerMFAEnforcement      RouteTemplate = "PUT /api/v1/servers/:id/mfa-enforcement"
