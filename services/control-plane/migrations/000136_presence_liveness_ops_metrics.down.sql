-- Migration: presence_liveness_ops_metrics (down)
-- Purpose: Narrow the closed metric catalog back to its 64-key 000135 form.
--
...
-- ACCESS EXCLUSIVE before the removals, matching the 000091, 000113 and 000135
...
DELETE FROM ops_metric_samples WHERE metric_key IN ('presence_ttl_lapsed_total', 'websocket_abnormal_closes_total');
DELETE FROM ops_metric_rollups WHERE metric_key IN ('presence_ttl_lapsed_total', 'websocket_abnormal_closes_total');
